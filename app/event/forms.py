...
class NewEventForm(FlaskForm):
    ...
    start_dt = DateTimeField('start_dt', [validators.DataRequired()], default=get_nearest_time(), format=date_fmt, widget=DateTimeInput())
    end_dt = DateTimeField('end_dt', [validators.DataRequired()], default=get_nearest_time_plus(minutes=30),
                           format=date_fmt, widget=DateTimeInput())
